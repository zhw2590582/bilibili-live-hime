  ...
  function () {
    ...
    createClass(Popup, [{
        ...
        return regenerator.async(function init$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return regenerator.awrap(getStorage('isRecording'));

              case 2:
                this.isRecording = _context.sent;
                _context.next = 5;
              ...
              case 11:
                ...
                this.$tab.value = "".concat(this.activeTab.title, " - ").concat(this.activeTab.url);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                this.$container.classList.add('isRecording');
                _context2.next = 11;
                return regenerator.awrap(setStorage('isRecording', true));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return regenerator.awrap(setStorage('isRecording', false));
      ...
      value: function log(msg) {
        return regenerator.async(function log$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                msg = msg instanceof Error ? msg.message.trim() : _objToString_1_0_1_objToString(msg);
                this.$debug.innerHTML += "<p>".concat(msg, "</p>");
                this.$debug.scrollTo(0, this.$debug.scrollHeight);
                _context4.next = 5;
                return regenerator.awrap(setStorage('debug', this.$debug.innerHTML));
