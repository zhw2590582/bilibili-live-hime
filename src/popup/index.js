	      ...
	      return regenerator.async(function init$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              _context.next = 2;
	              return regenerator.awrap(getStorage('live'));

	            case 2:
	              this.live = _context.sent;
	              _context.next = 5;
	        ...
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            ...
	            case 7:
	              ...
	              this.$container.classList.add('live');
	              _context2.next = 11;
	              return regenerator.awrap(setStorage('live', true));
	        ...
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              ...
	              _context3.next = 3;
	              return regenerator.awrap(setStorage('live', false));
