var BilibiliLiveHimeBackground = (function () {
	...
	function () {
	  function Background() {
	    ...
	    storageChange(function _callee(changes) {
	  ...
	  createClass(Background, [{
	    ...
	    value: function start() {
	      ...
	      return regenerator.async(function start$(_context5) {
	        while (1) {
	          switch (_context5.prev = _context5.next) {
	            ...
	            case 8:
	              ...
	              this.socket.on(RECONNECT, function _callee3(info) {
	              ...
	              this.socket.on(FAIL, function _callee4(info) {
	            ...
	            case 14:
	              ...
	              _context5.next = 18;
	              return regenerator.awrap(debug.err("".concat(SOCKET_FAIL, ": ").concat(_context5.t0.message.trim())));
	            ...
	            case 39:
	              this.mediaRecorder = _context5.sent;
	              _context5.next = 42;
	    ...
	    key: "stop",
	    value: function stop() {
	      return regenerator.async(function stop$(_context6) {
	        while (1) {
